...
print_help() {
  cat <<'EOF'
Usage: pm-portfolio-report.sh --config <path> [--json]
Description: Generate a portfolio-wide report in Markdown or JSON.
...
reject_placeholder_invocation() {
  printf '%s\n' "Phase 5 entry point placeholder: portfolio reporting is not implemented yet." >&2
