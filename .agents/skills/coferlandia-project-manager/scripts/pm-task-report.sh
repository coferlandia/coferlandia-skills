...
print_help() {
  cat <<'EOF'
Usage: pm-task-report.sh --config <path> --task <task-id> [--json]
...
reject_placeholder_invocation() {
  printf '%s\n' "Phase 5 entry point placeholder: task reporting is not implemented yet." >&2
