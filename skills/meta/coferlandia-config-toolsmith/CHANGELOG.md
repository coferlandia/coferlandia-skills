# Changelog — coferlandia-config-toolsmith
...
- Python and .NET platform-pack contracts with a universal Python fallback over approved native stores and APIs.
- Complete agent-documentation requirements for intent mapping, exact invocation, safety, validation, activation, and rollback.
